...
# # Define the endpoint
# @app.get("/")              
# async def search(query: str=QUERY):  #passing the query para
#     # **Similarity Search**
#     try:
...
# # /////////////////////////////////////////////////////////////////////////////////////////////////// 
# Uvicorn running on : - uvicorn api.main:app --reload [ http://127.0.0.1:8000 ] 
...
# **Initialize Pinecone Index for LangChain**
index = pc.Index(index_name)
vector_store = PineconeVectorStore(index, embeddings)  # Pass embeddings directly

# Add documents to the index
vector_store.add_texts([doc.page_content for doc in docs])

# Define the hardcoded query for testing
QUERY = "which are eastern zones"
